...
export const articles = {
  ...
  financeWebinars: ['Webinars & Micro-Events for Financial Firms in 2025', `${BLOG}/webinars-micro-events-for-financial-firms-in-2025/`],
  ...
  legalSeo: ['Law Firm SEO 2025: Cross-Channel Strategies for Lawyers', `${BLOG}/law-firm-seo-2025-cross-channel-strategies-for-lawyers/`],
  legalFundamentals: ['Reimagining Digital Marketing Fundamentals for Law Firms 2025', `${BLOG}/reimagining-digital-marketing-fundamentals-for-law-firms-2025/`],
  legalAnalytics: ['Measuring Marketing Incrementality and ROI in Legal Practices', `${BLOG}/law-firm-marketing-analytics-2025/`],
  advisorEmail: ['Email Marketing for Advisors in 2025: Timing, Personalization & Conversions', `${BLOG}/email-marketing-for-advisors-in-2025-timing-personalization-conversions/`],
  ...
  clinicReputation: ['Reputation Management for Clinics: Growing Your Google Profile in 2025', `${BLOG}/reputation-management-for-clinics-growing-your-google-profile-in-2025/`],
  lawyerVideo: ['Video Marketing for Lawyers: 4 Short-Form Formats That Work', `${BLOG}/video-marketing-for-lawyers/`],
};
