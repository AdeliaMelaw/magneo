    ...
    <main>
      <section className="nd-hero" aria-labelledby="nd-hero-title">
        ...
        <div className="nd-hero-art" aria-label="Blank papers, a document folder, and a pen arranged on a desk">
          <img src="/notary-document-desk-hero.png" alt="Blank papers layered over an ink-blue document folder beside a pen"/>
          <span className="nd-paper nd-paper-one" aria-hidden="true"/><span className="nd-paper nd-paper-two" aria-hidden="true"/>
