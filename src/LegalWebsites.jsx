...
const concepts = [
  ...
  { number:'07', type:'Notary services', title:'The document desk', route:'/portfolio/legal-websites/notary-document-desk/', image:'/notary-document-desk-hero-v3.png', className:'notary', description:'A precise editorial notary-services concept that makes document preparation and appointment expectations easy to understand.', tags:['Editorial','Organized','Service-led'] },
];
