(function () {
  ...
  function bindGuideForm() {
    ...
    form.addEventListener('submit', function (event) {
      ...
      fetch('/downloads/personal-branding-guide-legal-professionals.pdf', {
        method: 'POST',
        ...
        link.href = url;
        link.download = 'magneo-personal-branding-guide-legal-professionals.pdf';
        document.body.appendChild(link);
        link.click();
        link.remove();
        window.setTimeout(function () { URL.revokeObjectURL(url); }, 30000);
        status.textContent = 'Your Magneo guide has downloaded.';
        form.reset();
      }).catch(function () {
      ...
      <section class="guide-hero">\
        <div class="container guide-grid">\
          <div>\
            ...
            <div class="guide-actions"><a class="btn guide-form-cta" href="#guide-form">Fill out the form to download <span class="guide-form-arrow" aria-hidden="true">→</span></a><a class="btn outline" href="#tools-legal-niche">What is inside</a></div>\
          ...
          <aside class="guide-form-card" id="guide-form">\
            ...
            <form class="magneo-guide-form">\
              ...
              <label class="guide-consent"><input name="consent" type="checkbox" required><span>I agree that Magneo may store and use my information to provide the requested guide. Read the <a href="/privacy-policy/" target="_blank" rel="noopener">Magneo Privacy Policy</a>.</span></label>\
