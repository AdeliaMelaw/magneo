(function () {
  ...
  function addStyles() {
    ...
    style.textContent = '\
      .guide-hero{background:#050505;color:#fff;padding:150px 0 92px}.guide-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(340px,440px);gap:64px;align-items:start}.guide-hero h1{font-family:var(--display);font-size:clamp(48px,7vw,88px);font-weight:400;line-height:.96;letter-spacing:0;margin:28px 0 24px;max-width:900px}.guide-hero h1 em{color:#8cff00}.guide-intro{max-width:760px;color:rgba(255,255,255,.72);font-size:20px;line-height:1.7}.guide-points{display:flex;flex-wrap:wrap;gap:12px;margin-top:34px}.guide-points span{border:1px solid rgba(140,255,0,.3);border-radius:999px;padding:10px 14px;color:#cdeeb9;background:rgba(140,255,0,.06)}.guide-form-card{border:1px solid rgba(255,255,255,.14);border-radius:20px;background:#151515;padding:30px;box-shadow:0 24px 80px rgba(0,0,0,.35)}.guide-form-card h2{font-family:var(--display);font-size:40px;font-weight:400;margin:10px 0 12px}.guide-form-card p{color:rgba(255,255,255,.68);line-height:1.6}.guide-form-card .hs-form-frame{min-height:420px;margin-top:18px}.guide-download-ready{margin-top:22px;padding:18px;border-radius:14px;background:#ecffd9;color:#111}.guide-download-ready strong{display:block;margin-bottom:14px}.guide-detail{background:#fff}.guide-detail .card{background:#fff}@media(max-width:900px){.guide-hero{padding:112px 0 68px}.guide-grid{grid-template-columns:1fr;gap:36px}.guide-form-card{padding:24px}.guide-intro{font-size:18px}.guide-points span{font-size:13px}}';
