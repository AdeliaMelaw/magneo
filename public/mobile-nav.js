(function () {
  ...
  var marqueeSets = {
    law: [['LAW FIRM SEO', '/services/seo-for-the-legal-industry/'], ['LAW FIRM PPC', '/services/ppc-landing-pages-for-law-firms/'], ['SOCIAL MEDIA MARKETING', '/services/linkedin-growth-law-firms/'], ['LEGAL WEBSITE DESIGN', '/services/website-design-rebrand-for-law-firms-magneo/'], ['AI AUTOMATION & CRM', '/services/ai-automation-for-law-firms-legal-departments-magneo/'], ['LAW FIRM MARKETING', '/law-firm-marketing/']],
    finance: [['FINANCIAL SEO', '/services/seo-for-financial-advisors-wealth-firms/'], ['FINANCIAL PPC', '/services/ppc-landing-pages-for-financial-advisors-fintech/'], ['SOCIAL MEDIA MARKETING', '/services/linkedin-growth-financial-advisors/'], ['FINANCIAL WEBSITE DESIGN', '/services/website-design-for-financial-advisors-wealth-firms-magneo/'], ['AI AUTOMATION', '/services/ai-automation-for-financial-advisors-firms-fintech-magneo/'], ['FINANCIAL MARKETING', '/financial-firm-marketing/']],
    healthcare: [['HEALTHCARE SEO', '/services/seo-for-the-healthcare-medtech-industry/'], ['HEALTHCARE PPC', '/services/ppc-landing-pages-for-healthcare-medtech/'], ['HEALTHCARE SOCIAL MEDIA', '/services/social-media-linkedin-leadership-for-healthcare-providers-magneo/'], ['HEALTHCARE WEB DESIGN', '/services/website-design-for-healthcare-clinics-doctors-magneo/'], ['AI AUTOMATION', '/services/ai-automation-for-healthcare-providers-clinics-magneo/'], ['HEALTHCARE MARKETING', '/healthcare-marketing/']],
    ...
    ai: [['AI SEO', '/services/ai-seo/'], ['AI SOCIAL MEDIA MARKETING', '/services/ai-social-media-marketing/'], ['AI UGC & AI VIDEO PRODUCTION', '/services/ai-ugc-ai-video-production/'], ['AI WEB DESIGN & CONVERSION', '/services/ai-web-design-conversion/'], ['AI CONTENT MARKETING', '/services/ai-content-marketing/'], ['REGULATED GROWTH', '/services/ai-powered-digital-marketing/']],
services: [['SEO', '/services/seo-for-regulated-industries/'], ['PPC & LANDING PAGES', '/services/ppc-landing-pages-for-regulated-industries/'], ['Social Media Marketing', '/services/social-media-linkedin-marketing-for-regulated-industries/'], ['WEBSITE DESIGN', '/services/website-design-for-regulated-professional-industries-magneo/'], ['AI AUTOMATION & CRM', '/services/ai-automation-for-regulated-industries-magneo/'], ['PERSONAL BRANDING', '/services/personal-branding-for-regulated-professionals/']]
  };
  ...
  function marqueeForPath(path) {
    ...
    if (path.indexOf('/services/ai-ugc-ai-video-production') === 0) return null;
    if (path.indexOf('/services/ai-web-design-conversion') === 0) return null;
    ...
    if (path.indexOf('/services/ai-') === 0) return marqueeSets.ai;
